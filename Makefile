...
generate-proto:
	...
	python -m grpc_tools.protoc -I=internal/jams-proto/proto/api/v1/ --python_out=clients/python/jams/src/client/types/proto --pyi_out=clients/python/jams/src/client/types/proto --grpc_python_out=clients/python/jams/src/client/types/proto jams.proto
