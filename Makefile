...
generate-proto:
	...
	python -m grpc_tools.protoc -I=internal/jams-proto/proto/api/v1/ --python_out=clients/python/jams/src/jams/proto --pyi_out=clients/python/jams/src/jams/proto --grpc_python_out=clients/python/jams/src/jams/proto jams.proto
